...
CREATE TABLE `patient` (
  ...
  KEY `IDX_1ADAD7EB5AD9665` (`jyyw_id`),
  ...
  CONSTRAINT `FK_1ADAD7EB5AD9665` FOREIGN KEY (`jyyw_id`) REFERENCES `options` (`id`),
...
INSERT INTO `patient` VALUES (5,'1985-11-07',169,'2017-11-30','18116381898','李跃健','800003649',2,6,11,17,79,23,NULL,29,34,43,36,48,35,51,3,2),(6,'2017-11-07',NULL,'2014-02-02','18116381898','lee','62',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2019-11-07 11:13:03
