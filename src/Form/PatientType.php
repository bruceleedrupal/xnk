    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ->add('name',TextType::class,[
            ...
            ->add('yjqk',EntityType::class,[
                ...
                ->add('zyj',EntityType::class,[
                    'class'=>Options::class,
                    'choices'=>$this->optionsRespository->findChirenOptions(206),
                    'label'=>'造影剂种类',
                    'multiple'=>true,
                    'choice_label'=>'title',
                    'required'=>false,
                ...
                ->add('pcilj',EntityType::class,[
                    'class'=>Options::class,
                    'choices'=>$this->optionsRespository->findChirenOptions(211),
                    'label'=>'PCI路径',                    
                    'choice_label'=>'title',
                    'required'=>false,
                ])
                
                ->add('zrzj',EntityType::class,[
                    'class'=>Options::class,
                    'choices'=>$this->optionsRespository->findChirenOptions(215),
                    'label'=>'植入支架',
                    'multiple'=>true,
                    'choice_label'=>'title',
                    'required'=>false,
                ])
                ->add('clffzxg',EntityType::class,[
                    'class'=>Options::class,
                    'choices'=>$this->optionsRespository->findChirenOptions(219),
                    'label'=>'同时处理非犯罪血管',
                    'multiple'=>true,
                    'choice_label'=>'title',
                    'required'=>false,
                ])
                ->add('zyjjl',NumberType::class,[
                    'label'=>'造影剂剂量(ml)',
                    'html5'=>true,
                    'required'=>false,
                    'attr'=>[                      
